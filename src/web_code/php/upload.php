...
<table border=3 width=80% cellspacing=2 cellpadding=10 bordercolor=white>
<form action="upload.php" method=post enctype="multipart/form-data">
<input type=hidden name=action value=1> 
<tr>
	<th>檔案內容說明</th>
	<td bgcolor=white style="border-top-right-radius: 20px;">
	關鍵字 鍵值</td>
</tr>

<tr>
	<th>選擇上傳檔案</th>
	<td bgcolor=white style="border-bottom-right-radius: 20px;">
